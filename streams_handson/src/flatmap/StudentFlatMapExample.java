...
public class StudentFlatMapExample {
	...
	public static void main(String[] args) {
		...
		Student student2 = new Student(1,"abc",Arrays.asList("Hob6","Hob7","Hob8","Hob9"));
		Student student3 = new Student(1,"abc",Arrays.asList("Hob1","Hob11","Hob12","Hob13"));
		Student student4 = new Student(1,"abc",Arrays.asList("Hob14","Hob15","Hob16","Hob17"));
